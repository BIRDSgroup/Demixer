...
The postprocessing results reported in the manuscript are obtained by running the above command using the default value for the third parameter. The merged samples of invitro dataset (invitro.vcf.gz) can be downloaded from this [link](https://drive.google.com/drive/folders/1-zzEhnMofpfUvxH17KaJ23qp_SJzu9R4?usp=drive_link). For running this file, set db_name to **tbprof** and AD_COV to **2**. The reference database used by Demixer is constructed based on the robust SNPs presented in [this](https://genomemedicine.biomedcentral.com/articles/10.1186/s13073-020-00817-3) work.
